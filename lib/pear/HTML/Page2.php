...
class HTML_Page2 extends HTML_Common {
    ...
    /**
     * Raw data for head section (ie6 spcific hacks, e.g.)
     *
     * @var string
     * @access   private
     * @since   3.0
    ...
    function _generateHead()
    {
        ...
        // add raw data to head (ie6 spcific hacks, e.g.)
        foreach ($this->_rawdata as $rawdata) {
        	$strHtml .= $rawdata . $lnEnd;
        }
